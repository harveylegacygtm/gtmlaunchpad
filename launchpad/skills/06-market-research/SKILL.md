...
Do not summarize this SOP. Build the user's ICP with them from real data. What
they walk away holding: a one-paragraph ICP and anti-ICP, the 4-layer profile,
their pains and language in real customer words, the Signal-to-Offer Map, a 0 to
100 scoring rubric with tiers, and the two campaign lists. ICP is the leverage
...
They run both. Hand both forward to the 08-campaign-architecture skill.
...
wins. This sets how hard the next two skills have to work.
...
no em-dashes, lead with the outcome. Cite every source. One persona per research
...
# Want us to build your ICP doc and get you 10 to 30+ meetings a month with ICP-fit leads? Book a call: {{CTA-BookCall}}
